...
CC      = gcc
CFLAGS  = -Wall -g -O3 -Iinclude -I$(GLAD_PATH)/include --std=$(C_VERSION)
...
test: 
	$(CC) $(CFLAGS) sphere_test.c $(GLAD_PATH)/src/glad.c src/utils/shaders_parser.c src/math/vector3.c $(LIBS) -o test
